...
const $$Accordion = createComponent(($$result, $$props, $$slots) => {
  const content = [
    ...
    },
    {
      ...
      description: "Zubaka looks up the parcel's actual PostGIS geometry and matches it against the Kigali Masterplan's zoning categories \u2014 residential, commercial, mixed-use, or restricted/wetland \u2014 not whatever a broker tells you."
    },
    {
      index: 3,
...
const $$Process = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "process" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mt-[140px]"> ${renderComponent($$result2, "SectionTitle", $$SectionTitle, { "sectionTitle": "How Zubaka Works", "description": description })} ${renderComponent($$result2, "Accordion", $$Accordion, {})} </div> ` })}`;
