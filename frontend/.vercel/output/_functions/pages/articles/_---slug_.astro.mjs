...
import { a as getEntry } from '../../chunks/_astro_content_De8HskK-.mjs';
...
const $$Tags = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="flex flex-wrap gap-2"> ${tags.map((tag) => renderTemplate`<span class="px-2 py-1 bg-lime text-black rounded-full text-xs hover:opacity-90"><a${addAttribute("/articles/tag/" + tag, "href")}>#${capitalize(tag)}</a></span>`)} </div>`;
}, "C:/Users/HP/OneDrive/Documents/code/work/ideation/zubaka/frontend/src/components/ui/Tags.astro", void 0);
...
}, "C:/Users/HP/OneDrive/Documents/code/work/ideation/zubaka/frontend/src/pages/articles/[...slug].astro", void 0);

const $$file = "C:/Users/HP/OneDrive/Documents/code/work/ideation/zubaka/frontend/src/pages/articles/[...slug].astro";
