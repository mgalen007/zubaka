...
const $$Ai = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Zubaka AI Protection Assistant", "description": "Ask plain-language questions in Kinyarwanda or English about Kigali land masterplan rules, wetland demolition risks, and how to avoid informal broker scams." }, { "default": ($$result2) => renderTemplate(_a || (_a = __template([" ", ` <script>
    ...
    function appendUserMsg(text) {
      ...
      div.innerHTML = \`
        <div class="bg-green text-black font-medium p-4 rounded-2xl rounded-tr-none text-sm leading-relaxed max-w-[85%] shadow-md">
          \${escapeHtml(text)}
        </div>
        <div class="w-8 h-8 rounded-xl bg-white text-black font-bold text-xs flex items-center justify-center shrink-0">
          YOU
        </div>
      \`;
    ...
    function appendAiMsg(text) {
      ...
      div.innerHTML = \`
        <div class="w-8 h-8 rounded-xl bg-green flex items-center justify-center text-black font-bold text-xs shrink-0">
          AI
        </div>
        <div class="bg-zinc-800 text-zinc-100 p-4 rounded-2xl rounded-tl-none border border-zinc-700 text-sm leading-relaxed max-w-[85%] shadow-md">
          \${escapeHtml(text)}
        </div>
      \`;
      chatStream.appendChild(div);
  ...
  <\/script> `])), renderComponent($$result2, "Section", $$Section, {}, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="py-6"> ${renderComponent($$result3, "SectionTitle", $$SectionTitle, { "sectionTitle": "AI Land Protection Assistant", "description": "Grounded in Rwanda Land Authority laws and Kigali Masterplan rules to protect prospective buyers from illegal plot transactions." })} <div class="rounded-[45px] bg-[#191a23] text-white p-8 sm:p-12 border-2 border-black shadow-[0px_5px_0px_#b9ff66] font-grotesk max-w-4xl mx-auto flex flex-col space-y-6"> <!-- Header --> <div class="flex items-center justify-between border-b border-zinc-800 pb-4"> <div class="flex items-center gap-3"> <div class="w-12 h-12 rounded-2xl bg-green flex items-center justify-center text-black font-bold text-xl">
AI
</div> <div> <h3 class="text-2xl font-medium text-white">Zubaka Land Protection AI</h3> <p class="text-xs text-green">Grounded in Kigali Masterplan 2050 Data</p> </div> </div> <span class="greenhead text-xs font-medium hidden sm:inline">
Active Assistant
</span> </div> <!-- Chat Stream --> <div id="ai-chat-stream" class="flex-1 min-h-[340px] max-h-[480px] overflow-y-auto space-y-4 pr-2"> <div class="flex items-start gap-3"> <div class="w-8 h-8 rounded-xl bg-green flex items-center justify-center text-black font-bold text-xs shrink-0">
AI
